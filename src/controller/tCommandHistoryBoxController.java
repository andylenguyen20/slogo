...
public class tCommandHistoryBoxController extends tController implements ParserActionDelegate, ClearValueDelegate {
    private CommandHistoryBox commandHistoryBox;
    private CommandHistory commandHistory;
    private Parser parser;
    public tCommandHistoryBoxController(GUI gui, CommandHistory commandHistory, Parser parser){
        super(gui);
